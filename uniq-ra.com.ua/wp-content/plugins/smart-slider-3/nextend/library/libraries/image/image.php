...
class N2Image extends N2CacheImage {
    ...
    public static function resizeImage($group, $imageUrl, $targetWidth, $targetHeight, $mode = 'cover', $backgroundColor = false, $resizeRemote = false, $optimize = false, $x = 50, $y = 50) {
    ...
    protected function _resizeRemoteImage($filePath, $extension, $imageUrl, $targetWidth, $targetHeight, $mode, $backgroundColor, $optimize, $x, $y) {
        $this->_resizeImage($filePath, $extension, $imageUrl, $targetWidth, $targetHeight, $mode, $backgroundColor, $optimize, $x, $y);
    }

    protected function _resizeImage($filePath, $extension, $imagePath, $targetWidth, $targetHeight, $mode, $backgroundColor, $optimize = false, $x = 50, $y = 50) {
        $rotated = false;
        if ($extension == 'png') {
