...
(function ($, scope, undefined) {
    ...
    NextendSmartSliderLoad.prototype.onScroll = function () {
        ...
        if (($window.scrollTop() + $window.height() > (this.smartSlider.sliderElement.offset().top + 100))) {
            ...
            $.when(this.smartSlider.responsive.ready, this.smartSlider.backgroundImages.load).done($.proxy(this.showSlider, this, function (deferred) {
                setTimeout(function () {
                    deferred.resolve();
                }, 400);
            }));
    ...
    NextendSmartSliderResponsiveElement.prototype._resize = function (responsiveDimensions, ratio, timeline, duration) {
        ...
        if (timeline) {
            ...
            if (this.helper.centered) {
                ...
                this.element.css({
                    marginLeft: this.getHorizontalMargin(parseInt((this.helper.parent.width() - this.element.width()) / 2)),
