...
if (!function_exists('guardian_info_page')) {
	...
	$page1=add_theme_page(__('Welcome to Guardian', 'weblizar'), __('About Guardian', 'weblizar'), 'edit_theme_options', 'guardian', 'guardian_theme_info_page');
...
<div class="row theme-dtl guidline">
	<div class="col-md-6">
		...
		<p class="guidtext"><?php printf('1. To Configure Home Page Go to Admin Dashboard >> Appearance >> Customize >> Guardian Options >> Theme General Options. </br> Now Enable Show Front Page.', 'weblizar'); ?></p>
...
<div class="row proinfo">
	<div class="col-md-3">
	<h2> <?php printf(__('GUARDIAN PREMIUM THEME', 'weblizar')); ?> </h2>
	<h3><?php printf(__('Get Our Premium Theme', 'weblizar')); ?></h3>
	</div>
	<div class="col-md-3">
	<h1><?php printf(__('Our Latest Feature Set', 'weblizar')); ?></h1>
	<ul> 
	    <li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('Customize Front Page', 'weblizar')); ?></li>
		...
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('5 Portfolio Layout', 'weblizar')); ?></li>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('3 Page Layout', 'weblizar')); ?></li>
	</ul>
	</div>	
	<div class="col-md-3 new">
	<ul>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('3 Blog Layout', 'weblizar')); ?></li>
		...
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('3 Service Page Template', 'weblizar')); ?></li>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('About Us Page with short-code', 'weblizar')); ?></li>
	...
	<div class="col-md-3 plan-feature">
		<ul>
		<li><a href="http://demo.weblizar.com/preview/#guardian" target="_new" class="demo_button"><i class="fa fa-check-circle"></i> Demo</a></li>
		<li><a href="https://weblizar.com/themes/guardian-premium-theme/" target="_new" class="purchase_button"><i class="fa fa-shopping-cart"></i> Buy</a></li>
		</ul>
	</div>
</div>
